...
sys.path.insert(0,'liveenv\face_recognition_and_liveness\face_recognition')
...
def recognition_liveness(video_source,model_path, le_path, detector_folder, encodings, confidence=0.5):
    ...
    while True:
        ...
        for i in range(0, detections.shape[2]):
            ...
            if confidence > args['confidence']:
                ...
                encodings = sys.face_encodings(rgb)
                ...
                for encoding in encodings:
                    matches = sys.compare_faces(encoded_data['encodings'], encoding)
